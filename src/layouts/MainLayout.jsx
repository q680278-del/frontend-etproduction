...
// Socket.IO removed - using polling in dashboard instead
...
const MainLayout = ({ children }) => {
  ...
  // Socket removed for Vercel serverless compatibility
  ...
  useEffect(() => {
    ...
    // Poll for notifications every 10 seconds (replaces Socket.IO)
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div>
                ...
                <div className="flex space-x-4 mt-6">
                  ...
                  <a href="https://www.tiktok.com/@efnd_production" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-cyan-400 dark:hover:text-cyan-400 transition-colors">
              ...
              <div>
                ...
                <ul className="mt-4 space-y-2">
                  ...
                  <li><span className="text-sm text-gray-600 cursor-default dark:text-gray-400">Inisial Musik</span></li>
                </ul>
              </div>
